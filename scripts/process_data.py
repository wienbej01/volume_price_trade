...
def process_data(tickers: list, start_date: str, end_date: str, input_dir: str, output_dir: str):
...
if __name__ == "__main__":
    ...
    process_data(tickers=args.tickers, start_date=args.start_date, end_date=args.end_date, input_dir=args.input_dir, output_dir=args.output_dir)
